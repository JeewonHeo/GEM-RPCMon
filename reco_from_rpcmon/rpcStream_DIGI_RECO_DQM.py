...
process.GEMDigiSource.digisInputLabel = cms.InputTag("hltMuonGEMDigis", "")
...
process.schedule = cms.Schedule(process.reconstruction_step,process.recohits_step,process.dqmoffline_step,process.end_path)
# process.schedule = cms.Schedule(process.reconstruction_step,process.recohits_step,process.dqmoffline_step,process.DQMoutput_step)
